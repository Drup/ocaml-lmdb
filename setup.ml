...
(* OASIS_START *)
(* DO NOT EDIT (digest: 683aa934659d17cfce67aa8612c1af8f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "OCaml bindings for lmdb (http://symas.com/mdb/"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["lmdb_cstubs.c"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-llmdb"])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "lmdb_bindgen.ml"});
               Executable
                 ({
                     cs_name = "lmdb_typegen";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "lmdb_typegen.ml"});
               Executable
                 ({
                     cs_name = "version";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lmdb"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "version.ml"});
               Test
                 ({
                     cs_name = "version";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "simple_db.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for OCaml-lmdb";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest =
       Some "\255\132\220\163\212\004{\158\170\2425S\191\195\244\209";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
